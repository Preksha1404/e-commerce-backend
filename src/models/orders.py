...
class Order(Base):
    ...
    items = relationship("src.models.orders.OrderItem", back_populates="order", cascade="all, delete-orphan")
    user = relationship("src.models.users.User", back_populates="orders")
    address = relationship("src.models.addresses.Address", back_populates="orders")
